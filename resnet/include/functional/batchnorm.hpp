...
void hostBatchNorm2d(float *to_be_modified_data, const float *mean_data, const float *var_data,
                     const float *weight_data, const float *bias_data,
                     float eps, int batch_size, int num_channels,
                     int height, int width);

void hostBatchNorm2dRelu(float *to_be_modified_data, const float *mean_data, const float *var_data,
                         const float *weight_data, const float *bias_data,
                         float eps, int batch_size, int num_channels,
                         int height, int width);
