...
namespace Sim
{
                    ...
                    f16 *a, f16 *b, f32 *c)
    {
        ...
        sim.IMAD_INSTR(warp, true, 20, 5, 12, reinterpret_cast<intptr_t>(a), 0b001); // IMAD.WIDE.U32 R20, R5, R12, c[0x0][0x160] ;
        sim.IMAD_INSTR(warp, true, 12, 7, 12, reinterpret_cast<intptr_t>(b), 0b001); // IMAD.WIDE.U32 R12, R7, R12, c[0x0][0x168] ;
        ...
        sim.HMMA_INSTR_STEP0(warp, 8, 24, 16, 8);              // HMMA.884.F32.F32.STEP0 R8, R24.reuse.ROW, R16.reuse.COL, R8 ;
        sim.HMMA_INSTR_STEP1(warp, 10, 24, 16, 10);            // HMMA.884.F32.F32.STEP1 R10, R24.reuse.ROW, R16.reuse.COL, R10 ;
        sim.HMMA_INSTR_STEP2(warp, 4, 24, 16, 4);              // HMMA.884.F32.F32.STEP2 R4, R24.reuse.ROW, R16.reuse.COL, R4 ;
        sim.HMMA_INSTR_STEP3(warp, 6, 24, 16, 6);              // HMMA.884.F32.F32.STEP3 R6, R24.ROW, R16.COL, R6 ;
        sim.HMMA_INSTR_STEP0(warp, 8, 26, 18, 8);              // HMMA.884.F32.F32.STEP0 R8, R26.reuse.ROW, R18.reuse.COL, R8 ;
        sim.HMMA_INSTR_STEP1(warp, 10, 26, 18, 10);            // HMMA.884.F32.F32.STEP1 R10, R26.reuse.ROW, R18.reuse.COL, R10 ;
        sim.HMMA_INSTR_STEP2(warp, 4, 26, 18, 4);              // HMMA.884.F32.F32.STEP2 R4, R26.reuse.ROW, R18.reuse.COL, R4 ;
        sim.HMMA_INSTR_STEP3(warp, 6, 26, 18, 6);              // HMMA.884.F32.F32.STEP3 R6, R26.ROW, R18.COL, R6 ;
        sim.HMMA_INSTR_STEP0(warp, 8, 20, 12, 8);              // HMMA.884.F32.F32.STEP0 R8, R20.reuse.ROW, R12.reuse.COL, R8 ;
        sim.HMMA_INSTR_STEP1(warp, 10, 20, 12, 10);            // HMMA.884.F32.F32.STEP1 R10, R20.reuse.ROW, R12.reuse.COL, R10 ;
        sim.HMMA_INSTR_STEP2(warp, 4, 20, 12, 4);              // HMMA.884.F32.F32.STEP2 R4, R20.reuse.ROW, R12.reuse.COL, R4 ;
        sim.HMMA_INSTR_STEP3(warp, 6, 20, 12, 6);              // HMMA.884.F32.F32.STEP3 R6, R20.ROW, R12.COL, R6 ;
        sim.HMMA_INSTR_STEP0(warp, 8, 22, 14, 8);              // HMMA.884.F32.F32.STEP0 R8, R22.reuse.ROW, R14.reuse.COL, R8 ;
        sim.HMMA_INSTR_STEP1(warp, 10, 22, 14, 10);            // HMMA.884.F32.F32.STEP1 R10, R22.reuse.ROW, R14.reuse.COL, R10 ;
        sim.HMMA_INSTR_STEP2(warp, 4, 22, 14, 4);              // HMMA.884.F32.F32.STEP2 R4, R22.reuse.ROW, R14.reuse.COL, R4 ;
